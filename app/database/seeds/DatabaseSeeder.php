...
class UserTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        User::create(array('email' => 'test@test.com', 'firstname' => 'testF', 'lastname' => 'testL', 'username' => 'test', 'password' => $password));
    }
}
...
class LogEntrySeeder extends Seeder {
	...
	public function run() {
		...
		$userSelect = DB::table('user')->where('username', 'test')->pluck('id');


		/* log for FEB 03rd, 2014. All logs are under the user 'test' with the password 'password' */
		...
		/* log for FEB 04th, 2014. All logs are under the user 'test' with the password 'password' */
		...
		/* log for FEB 05th, 2014. All logs are under the user 'test' with the password 'password' */
		...
		/* log for FEB 06th, 2014. All logs are under the user 'test' with the password 'password' */
